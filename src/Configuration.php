...
class Configuration
{
     ...
     *
     * @var \RusticiSoftware\Cloud\V2\ApiClient
     */
     ...
     * @var string
     */
    protected $host = 'https://dev.cloud.scorm.com/api/v2/';
     ...
     * @var string
     */
    protected $userAgent = "Swagger-Codegen/1.0.0-beta/php";
    ...
    {
        $report  = 'PHP SDK (RusticiSoftware\Cloud\V2) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . phpversion() . PHP_EOL;
        $report .= '    OpenAPI Spec Version: 2.0 beta' . PHP_EOL;
        $report .= '    SDK Package Version: 1.0.0-beta' . PHP_EOL;
