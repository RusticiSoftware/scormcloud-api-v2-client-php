...
class CourseSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['course_learning_standard'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'course_learning_standard', must be one of 'UNKNOWN', 'SCORM11', 'SCORM12', 'SCORM20042NDEDITION', 'SCORM20043RDEDITION', 'SCORM20044THEDITION', 'AICC', 'XAPI', 'CMI5'.";
        }
    ...
    public function setCourseLearningStandard($course_learning_standard)
    {
        ...
        if (!is_null($course_learning_standard) && (!in_array($course_learning_standard, $allowed_values))) {
