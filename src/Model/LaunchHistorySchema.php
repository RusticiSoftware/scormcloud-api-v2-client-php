...
class LaunchHistorySchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['completion_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'completion_status', must be one of #{allowed_values}.";
        }

        $allowed_values = array("UNKNOWN", "PASSED", "FAILED");
        if (!in_array($this->container['success_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'success_status', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('UNKNOWN', 'COMPLETED', 'INCOMPLETE');
        if (!in_array($completion_status, $allowed_values)) {
    ...
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!in_array($success_status, $allowed_values)) {
