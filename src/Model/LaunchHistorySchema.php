 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class LaunchHistorySchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['completion_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'completion_status', must be one of 'UNKNOWN', 'COMPLETED', 'INCOMPLETE'.";
        }

        $allowed_values = ["UNKNOWN", "PASSED", "FAILED"];
        if (!in_array($this->container['success_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'success_status', must be one of 'UNKNOWN', 'PASSED', 'FAILED'.";
        }
    ...
    public function setCompletionStatus($completion_status)
    {
        ...
        if (!is_null($completion_status) && (!in_array($completion_status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'completion_status', must be one of 'UNKNOWN', 'COMPLETED', 'INCOMPLETE'");
        }
    ...
    public function setSuccessStatus($success_status)
    {
        ...
        if (!is_null($success_status) && (!in_array($success_status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'success_status', must be one of 'UNKNOWN', 'PASSED', 'FAILED'");
        }
