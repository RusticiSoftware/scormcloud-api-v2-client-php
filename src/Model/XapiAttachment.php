 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class XapiAttachment implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['usage_type'] === null) {
            $invalid_properties[] = "'usage_type' can't be null";
        }
        if ($this->container['display'] === null) {
            $invalid_properties[] = "'display' can't be null";
        }
        ...
        if ($this->container['sha2'] === null) {
            $invalid_properties[] = "'sha2' can't be null";
        }
