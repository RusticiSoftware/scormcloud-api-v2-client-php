...
/**
 * InvitationSummaryList Class Doc Comment
 *
 * @category Class
 * @package  RusticiSoftware\Cloud\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class InvitationSummaryList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'InvitationSummaryList';
    ...
    protected static $swaggerTypes = [
        'invitations' => '\RusticiSoftware\Cloud\V2\Model\InvitationSummarySchema[]',
        'more' => 'string'
    ];
     ...
     * Sets invitations
     *
     * @param \RusticiSoftware\Cloud\V2\Model\InvitationSummarySchema[] $invitations A list of invitation overview objects.
     *
     * @return $this
     */
