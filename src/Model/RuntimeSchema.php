 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RuntimeSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['runtime_success_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'runtime_success_status', must be one of 'UNKNOWN', 'PASSED', 'FAILED'.";
        }
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\LearnerPreferenceSchema $learner_preference
     * @return $this
     */
     ...
     * @param string $runtime_success_status
     * @return $this
     */
    public function setRuntimeSuccessStatus($runtime_success_status)
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!is_null($runtime_success_status) && (!in_array($runtime_success_status, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'runtime_success_status', must be one of 'UNKNOWN', 'PASSED', 'FAILED'");
        }
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\CommentSchema[] $learner_comments
     * @return $this
     */
    ...
    /**
     * Sets lms_comments
     * @param \RusticiSoftware\Cloud\V2\Model\CommentSchema[] $lms_comments
     * @return $this
     */
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\RuntimeInteractionSchema[] $runtime_interactions
     * @return $this
     */
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\RuntimeObjectiveSchema[] $runtime_objectives
     * @return $this
     */
