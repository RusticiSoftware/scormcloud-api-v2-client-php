 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RuntimeInteractionSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'type', must be one of 'TrueFalse', 'Choice', 'FillIn', 'LongFillIn', 'Likert', 'Matching', 'Performance', 'Sequencing', 'Numeric', 'Other'.";
        }
    ...
    {
        $allowed_values = array('TrueFalse', 'Choice', 'FillIn', 'LongFillIn', 'Likert', 'Matching', 'Performance', 'Sequencing', 'Numeric', 'Other');
        if (!is_null($type) && (!in_array($type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'type', must be one of 'TrueFalse', 'Choice', 'FillIn', 'LongFillIn', 'Likert', 'Matching', 'Performance', 'Sequencing', 'Numeric', 'Other'");
        }
