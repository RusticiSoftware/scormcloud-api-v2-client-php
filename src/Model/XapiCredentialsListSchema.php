 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class XapiCredentialsListSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['xapi_credentials'] === null) {
            $invalid_properties[] = "'xapi_credentials' can't be null";
        }
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\XapiCredentialSchema[] $xapi_credentials
     * @return $this
     */
