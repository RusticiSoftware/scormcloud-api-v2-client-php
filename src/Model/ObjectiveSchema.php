 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class ObjectiveSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['objective_completion'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'objective_completion', must be one of 'UNKNOWN', 'COMPLETED', 'INCOMPLETE'.";
        }

        $allowed_values = ["UNKNOWN", "PASSED", "FAILED"];
        if (!in_array($this->container['objective_success'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'objective_success', must be one of 'UNKNOWN', 'PASSED', 'FAILED'.";
        }

        $allowed_values = ["UNKNOWN", "PASSED", "FAILED"];
        if (!in_array($this->container['previous_objective_success'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'previous_objective_success', must be one of 'UNKNOWN', 'PASSED', 'FAILED'.";
        }
     ...
     * @param double $previous_score_scaled
     * @return $this
     */
     ...
     * @param double $first_score_scaled
     * @return $this
     */
     ...
     * @param string $first_success_time_stamp
     * @return $this
     */
     ...
     * @param string $objective_completion
     * @return $this
     */
    public function setObjectiveCompletion($objective_completion)
    {
        $allowed_values = array('UNKNOWN', 'COMPLETED', 'INCOMPLETE');
        if (!is_null($objective_completion) && (!in_array($objective_completion, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'objective_completion', must be one of 'UNKNOWN', 'COMPLETED', 'INCOMPLETE'");
        }
     ...
     * @param string $objective_success
     * @return $this
     */
    public function setObjectiveSuccess($objective_success)
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!is_null($objective_success) && (!in_array($objective_success, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'objective_success', must be one of 'UNKNOWN', 'PASSED', 'FAILED'");
        }
     ...
     * @param string $previous_objective_success
     * @return $this
     */
    public function setPreviousObjectiveSuccess($previous_objective_success)
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!is_null($previous_objective_success) && (!in_array($previous_objective_success, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'previous_objective_success', must be one of 'UNKNOWN', 'PASSED', 'FAILED'");
        }
