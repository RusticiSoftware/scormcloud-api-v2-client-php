...
class PostBackSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['auth_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'auth_type', must be one of 'UNDEFINED', 'FORM', 'HTTPBASIC'.";
        }

        $allowed_values = ["UNDEFINED", "COURSE", "ACTIVITY", "FULL"];
        if (!in_array($this->container['results_format'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'results_format', must be one of 'UNDEFINED', 'COURSE', 'ACTIVITY', 'FULL'.";
        }
    ...
    {
        $allowed_values = array('UNDEFINED', 'COURSE', 'ACTIVITY', 'FULL');
        if (!is_null($results_format) && (!in_array($results_format, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'results_format', must be one of 'UNDEFINED', 'COURSE', 'ACTIVITY', 'FULL'");
        }
