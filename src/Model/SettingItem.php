...
class SettingItem implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['effective_value_source'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'effective_value_source', must be one of 'default', 'fallback', 'base', 'system', 'learningStandard', 'application', 'learningStandardForApplication', 'dispatchDestination', 'course', 'dispatchDestinationForCourse', 'registration'.";
        }
