...
class SettingMetadata implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['learning_standard_variant'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'learning_standard_variant', must be one of 'singleScoOnly', 'multiScoOnly', 'either'.";
        }
    ...
    public function setLearningStandardVariant($learning_standard_variant)
    {
        ...
        if (!is_null($learning_standard_variant) && (!in_array($learning_standard_variant, $allowed_values))) {
