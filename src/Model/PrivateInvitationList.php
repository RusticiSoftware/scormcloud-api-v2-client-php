...
/**
 * PrivateInvitationList Class Doc Comment
 *
 * @category Class
 * @package  RusticiSoftware\Cloud\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PrivateInvitationList implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PrivateInvitationList';
    ...
    protected static $swaggerTypes = [
        'invitations' => '\RusticiSoftware\Cloud\V2\Model\PrivateInvitationSchema[]',
        'more' => 'string'
    ];
     ...
     * Sets invitations
     *
     * @param \RusticiSoftware\Cloud\V2\Model\PrivateInvitationSchema[] $invitations A list of private invitation objects.
     *
     * @return $this
     */
