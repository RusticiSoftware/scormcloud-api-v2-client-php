 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DestinationIdSchema implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'data' => '\RusticiSoftware\Cloud\V2\Model\DestinationSchema'
    ];
    ...
    /**
     * Sets data
     * @param \RusticiSoftware\Cloud\V2\Model\DestinationSchema $data
     * @return $this
     */
