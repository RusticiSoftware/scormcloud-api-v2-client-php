 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class DispatchIdSchema implements ArrayAccess
{
    ...
    protected static $swaggerTypes = [
        'id' => 'string',
        'data' => '\RusticiSoftware\Cloud\V2\Model\DispatchSchema'
    ];
    ...
    /**
     * Sets data
     * @param \RusticiSoftware\Cloud\V2\Model\DispatchSchema $data
     * @return $this
     */
