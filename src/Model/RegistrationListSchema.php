 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class RegistrationListSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['registrations'] === null) {
            $invalid_properties[] = "'registrations' can't be null";
        }
    ...
    /**
     * Sets registrations
     * @param \RusticiSoftware\Cloud\V2\Model\RegistrationSchema[] $registrations
     * @return $this
     */
