...
class RuntimeObjectiveSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['runtime_objective_success_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'runtime_objective_success_status', must be one of 'UNKNOWN', 'PASSED', 'FAILED'.";
        }
        ...
        if (!in_array($this->container['runtime_objective_completion_status'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'runtime_objective_completion_status', must be one of 'UNKNOWN', 'COMPLETED', 'INCOMPLETE', 'NOT_ATTEMPTED', 'BROWSED'.";
        }
    ...
    public function setRuntimeObjectiveSuccessStatus($runtime_objective_success_status)
    {
        ...
        if (!is_null($runtime_objective_success_status) && (!in_array($runtime_objective_success_status, $allowed_values))) {
    ...
    public function setRuntimeObjectiveCompletionStatus($runtime_objective_completion_status)
    {
        ...
        if (!is_null($runtime_objective_completion_status) && (!in_array($runtime_objective_completion_status, $allowed_values))) {
