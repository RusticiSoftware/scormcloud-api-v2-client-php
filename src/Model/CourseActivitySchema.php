 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CourseActivitySchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['activity_type'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'activity_type', must be one of 'UNKNOWN', 'AGGREGATION', 'SCO', 'ASSET', 'OBJECTIVE'.";
        }
    ...
    {
        $allowed_values = array('UNKNOWN', 'AGGREGATION', 'SCO', 'ASSET', 'OBJECTIVE');
        if (!is_null($activity_type) && (!in_array($activity_type, $allowed_values))) {
            throw new \InvalidArgumentException("Invalid value for 'activity_type', must be one of 'UNKNOWN', 'AGGREGATION', 'SCO', 'ASSET', 'OBJECTIVE'");
        }
    ...
    /**
     * Sets children
     * @param \RusticiSoftware\Cloud\V2\Model\CourseActivitySchema[] $children
     * @return $this
     */
