 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class SettingListSchema implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['setting_items'] === null) {
            $invalid_properties[] = "'setting_items' can't be null";
        }
    ...
    /**
     * Sets setting_items
     * @param \RusticiSoftware\Cloud\V2\Model\SettingItem[] $setting_items
     * @return $this
     */
