...
/**
 * PublicInvitationSchema Class Doc Comment
 *
 * @category Class
 * @package  RusticiSoftware\Cloud\V2
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class PublicInvitationSchema implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'PublicInvitationSchema';
     ...
     * Sets url
     *
     * @param string $url The launch URL for the invitation
     *
     * @return $this
     */
