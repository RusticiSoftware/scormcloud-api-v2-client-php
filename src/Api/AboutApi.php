...
class AboutApi
{
    ...
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\AboutSchema';
        $request = $this->getAboutRequest();
     ...
     */
    public function getAboutAsync()
    {
        return $this->getAboutAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAboutAsyncWithHttpInfo()
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\AboutSchema';
        $request = $this->getAboutRequest();
     ...
     */
    protected function getAboutRequest()
    {
