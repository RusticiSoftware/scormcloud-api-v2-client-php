...
class XapiApi
{
     ...
     */
    public function getXapiCredentials($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'credential_id', $order_by = 'updated_asc', $more = null, $include_total_count = 'false')
    {
        list($response) = $this->getXapiCredentialsWithHttpInfo($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_total_count);
        return $response;
    }
     ...
     */
    public function getXapiCredentialsWithHttpInfo($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'credential_id', $order_by = 'updated_asc', $more = null, $include_total_count = 'false')
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\XapiCredentialsListSchema';
        $request = $this->getXapiCredentialsRequest($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_total_count);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getXapiCredentialsAsync($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'credential_id', $order_by = 'updated_asc', $more = null, $include_total_count = 'false')
    {
        return $this->getXapiCredentialsAsyncWithHttpInfo($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_total_count)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getXapiCredentialsAsyncWithHttpInfo($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'credential_id', $order_by = 'updated_asc', $more = null, $include_total_count = 'false')
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\XapiCredentialsListSchema';
        $request = $this->getXapiCredentialsRequest($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_total_count);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getXapiCredentialsRequest($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'credential_id', $order_by = 'updated_asc', $more = null, $include_total_count = 'false')
    {
