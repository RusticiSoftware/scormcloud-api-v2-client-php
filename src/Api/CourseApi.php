...
class CourseApi
{
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createUploadAndImportCourseJobAsync($course_id, $may_create_new_version = 'false', $file = null, $postback_url = null)
    {
        return $this->createUploadAndImportCourseJobAsyncWithHttpInfo($course_id, $may_create_new_version, $file, $postback_url)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createUploadAndImportCourseJobRequest($course_id, $may_create_new_version = 'false', $file = null, $postback_url = null)
    {
        // verify the required parameter 'course_id' is set
        if ($course_id === null || (is_array($course_id) && count($course_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    protected function getCoursesRequest($more = null, $since = null, $until = null, $filter = null, $filter_by = null, $order_by = null, $include_registration_count = 'false', $include_course_metadata = 'false', $tags = null)
    {
        ...
        // query params
        if (is_array($tags)) {
            $tags = ObjectSerializer::serializeCollection($tags, 'ssv', true);
        }
        if ($tags !== null) {
