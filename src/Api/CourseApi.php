...
class CourseApi
{
     ...
     * @param  \RusticiSoftware\Cloud\V2\Model\PreviewLaunchLinkRequestSchema $launch_link_request launch_link_request (required)
     *
     ...
     * @param  \RusticiSoftware\Cloud\V2\Model\PreviewLaunchLinkRequestSchema $launch_link_request (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     * @return \SplFileObject
     */
    public function getCourseZip($course_id)
    {
        list($response) = $this->getCourseZipWithHttpInfo($course_id);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCourseZipWithHttpInfo($course_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->getCourseZipRequest($course_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCourseZipAsync($course_id)
    {
        return $this->getCourseZipAsyncWithHttpInfo($course_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getCourseZipAsyncWithHttpInfo($course_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->getCourseZipRequest($course_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getCourseZipRequest($course_id)
    {
        // verify the required parameter 'course_id' is set
        if ($course_id === null || (is_array($course_id) && count($course_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \SplFileObject
     */
    public function getVersionedCourseZip($course_id, $version_id)
    {
        list($response) = $this->getVersionedCourseZipWithHttpInfo($course_id, $version_id);
        return $response;
    }
     ...
     * @return array of \SplFileObject, HTTP status code, HTTP response headers (array of strings)
     */
    public function getVersionedCourseZipWithHttpInfo($course_id, $version_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->getVersionedCourseZipRequest($course_id, $version_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionedCourseZipAsync($course_id, $version_id)
    {
        return $this->getVersionedCourseZipAsyncWithHttpInfo($course_id, $version_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getVersionedCourseZipAsyncWithHttpInfo($course_id, $version_id)
    {
        $returnType = '\SplFileObject';
        $request = $this->getVersionedCourseZipRequest($course_id, $version_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getVersionedCourseZipRequest($course_id, $version_id)
    {
        // verify the required parameter 'course_id' is set
        if ($course_id === null || (is_array($course_id) && count($course_id) === 0)) {
            throw new \InvalidArgumentException(
