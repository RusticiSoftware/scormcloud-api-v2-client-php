...
class ApplicationManagementApi
{
     ...
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \RusticiSoftware\Cloud\V2\Model\CredentialSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function createCredentialWithHttpInfo($child_app_id, $credential_request)
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\CredentialSchema';
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RusticiSoftware\Cloud\V2\Model\CredentialSchema',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @deprecated Use GetApplicationsAsync instead.
     */
     ...
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Promise\PromiseInterface
     * @deprecated Use GetApplicationsAsyncWithHttpInfo instead.
     */
     ...
     * @param  string $filter_by Optional enum parameter for specifying the field on which to run the filter. (optional, default to app_id)
     ...
     */
    public function getApplications($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'app_id', $order_by = 'updated_asc', $more = null, $include_course_count = 'false', $include_registration_count = 'false', $include_total_count = 'false')
    {
        list($response) = $this->getApplicationsWithHttpInfo($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_course_count, $include_registration_count, $include_total_count);
        return $response;
    }
     ...
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \RusticiSoftware\Cloud\V2\Model\ApplicationInfoListSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getApplicationsWithHttpInfo($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'app_id', $order_by = 'updated_asc', $more = null, $include_course_count = 'false', $include_registration_count = 'false', $include_total_count = 'false')
    {
        ...
        try {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\RusticiSoftware\Cloud\V2\Model\ApplicationInfoListSchema',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getApplicationsAsync($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'app_id', $order_by = 'updated_asc', $more = null, $include_course_count = 'false', $include_registration_count = 'false', $include_total_count = 'false')
    {
        return $this->getApplicationsAsyncWithHttpInfo($since, $until, $datetime_filter, $filter, $filter_by, $order_by, $more, $include_course_count, $include_registration_count, $include_total_count)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getApplicationsRequest($since = null, $until = null, $datetime_filter = 'updated', $filter = null, $filter_by = 'app_id', $order_by = 'updated_asc', $more = null, $include_course_count = 'false', $include_registration_count = 'false', $include_total_count = 'false')
    {

        $resourcePath = '/appManagement/applicationList';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
