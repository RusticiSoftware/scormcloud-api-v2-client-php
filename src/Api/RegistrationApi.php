...
class RegistrationApi
{
     ...
     * @return \RusticiSoftware\Cloud\V2\Model\RegistrationListSchema
     */
    public function getRegistrations($course_id = null, $learner_id = null, $since = null, $until = null, $datetime_filter = 'created', $tags = null, $filter = null, $filter_by = 'registration_id', $order_by = 'created_desc', $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false', $include_total_count = 'false')
    {
        list($response) = $this->getRegistrationsWithHttpInfo($course_id, $learner_id, $since, $until, $datetime_filter, $tags, $filter, $filter_by, $order_by, $more, $include_child_results, $include_interactions_and_objectives, $include_runtime, $include_total_count);
        return $response;
    }
     ...
     * @return array of \RusticiSoftware\Cloud\V2\Model\RegistrationListSchema, HTTP status code, HTTP response headers (array of strings)
     */
    public function getRegistrationsWithHttpInfo($course_id = null, $learner_id = null, $since = null, $until = null, $datetime_filter = 'created', $tags = null, $filter = null, $filter_by = 'registration_id', $order_by = 'created_desc', $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false', $include_total_count = 'false')
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\RegistrationListSchema';
        $request = $this->getRegistrationsRequest($course_id, $learner_id, $since, $until, $datetime_filter, $tags, $filter, $filter_by, $order_by, $more, $include_child_results, $include_interactions_and_objectives, $include_runtime, $include_total_count);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRegistrationsAsync($course_id = null, $learner_id = null, $since = null, $until = null, $datetime_filter = 'created', $tags = null, $filter = null, $filter_by = 'registration_id', $order_by = 'created_desc', $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false', $include_total_count = 'false')
    {
        return $this->getRegistrationsAsyncWithHttpInfo($course_id, $learner_id, $since, $until, $datetime_filter, $tags, $filter, $filter_by, $order_by, $more, $include_child_results, $include_interactions_and_objectives, $include_runtime, $include_total_count)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRegistrationsAsyncWithHttpInfo($course_id = null, $learner_id = null, $since = null, $until = null, $datetime_filter = 'created', $tags = null, $filter = null, $filter_by = 'registration_id', $order_by = 'created_desc', $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false', $include_total_count = 'false')
    {
        $returnType = '\RusticiSoftware\Cloud\V2\Model\RegistrationListSchema';
        $request = $this->getRegistrationsRequest($course_id, $learner_id, $since, $until, $datetime_filter, $tags, $filter, $filter_by, $order_by, $more, $include_child_results, $include_interactions_and_objectives, $include_runtime, $include_total_count);
