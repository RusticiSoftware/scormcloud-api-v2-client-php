...
class RegistrationApi
{
    ...
    {
        $this->deleteRegistrationsGlobalDataWithHttpInfo($registration_id);
    }
    ...
    {
        $returnType = '';
        $request = $this->deleteRegistrationsGlobalDataRequest($registration_id);
    ...
    /**
     * Operation deleteRegistrationsGlobalDataAsync
     *
     * Delete global data associated with `registrationId`
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRegistrationsGlobalDataAsync($registration_id)
    {
        return $this->deleteRegistrationsGlobalDataAsyncWithHttpInfo($registration_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation deleteRegistrationsGlobalDataAsyncWithHttpInfo
     *
     * Delete global data associated with `registrationId`
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function deleteRegistrationsGlobalDataAsyncWithHttpInfo($registration_id)
    {
        $returnType = '';
        $request = $this->deleteRegistrationsGlobalDataRequest($registration_id);
    ...
    /**
     * Create request for operation 'deleteRegistrationsGlobalData'
     *
     * @param  string $registration_id id for this registration (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteRegistrationsGlobalDataRequest($registration_id)
    {
        // verify the required parameter 'registration_id' is set
        if ($registration_id === null || (is_array($registration_id) && count($registration_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $registration_id when calling deleteRegistrationsGlobalData'
            );
        }
    ...
    /**
     * Operation getRegistrationLaunchLinkAsync
     *
     * Returns the link to use to launch this registration
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRegistrationLaunchLinkAsync($registration_id, $launch_link_request)
    {
        return $this->getRegistrationLaunchLinkAsyncWithHttpInfo($registration_id, $launch_link_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getRegistrationLaunchLinkAsyncWithHttpInfo
     *
     * Returns the link to use to launch this registration
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRegistrationLaunchLinkRequest($registration_id, $launch_link_request)
    {
        // verify the required parameter 'registration_id' is set
        if ($registration_id === null || (is_array($registration_id) && count($registration_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $registration_id when calling getRegistrationLaunchLink'
            );
        }
        ...
        if ($launch_link_request === null || (is_array($launch_link_request) && count($launch_link_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $launch_link_request when calling getRegistrationLaunchLink'
            );
        }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getRegistrationsAsync($course_id = null, $learner_id = null, $since = null, $until = null, $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false')
    {
        return $this->getRegistrationsAsyncWithHttpInfo($course_id, $learner_id, $since, $until, $more, $include_child_results, $include_interactions_and_objectives, $include_runtime)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getRegistrationsRequest($course_id = null, $learner_id = null, $since = null, $until = null, $more = null, $include_child_results = 'false', $include_interactions_and_objectives = 'false', $include_runtime = 'false')
    {
    ...
    {
        $this->registrationExistsWithHttpInfo($registration_id);
    }
    ...
    {
        $returnType = '';
        $request = $this->registrationExistsRequest($registration_id);
    ...
    /**
     * Operation registrationExistsAsync
     *
     * Does this registration exist?
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registrationExistsAsync($registration_id)
    {
        return $this->registrationExistsAsyncWithHttpInfo($registration_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation registrationExistsAsyncWithHttpInfo
     *
     * Does this registration exist?
     *
     * @param  string $registration_id id for this registration (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function registrationExistsAsyncWithHttpInfo($registration_id)
    {
        $returnType = '';
        $request = $this->registrationExistsRequest($registration_id);
    ...
    /**
     * Create request for operation 'registrationExists'
     *
     * @param  string $registration_id id for this registration (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function registrationExistsRequest($registration_id)
    {
        // verify the required parameter 'registration_id' is set
        if ($registration_id === null || (is_array($registration_id) && count($registration_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $registration_id when calling registrationExists'
            );
        }
