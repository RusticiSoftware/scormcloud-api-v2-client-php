...
class RegistrationApi
{
    ...
    public function buildRegistrationLaunchLinkWithHttpInfo($registration_id, $launch_link_request)
    {
        ...
        if ($registration_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $registration_id when calling buildRegistrationLaunchLink');
        }
        // verify the required parameter 'launch_link_request' is set
        if ($launch_link_request === null) {
            throw new \InvalidArgumentException('Missing the required parameter $launch_link_request when calling buildRegistrationLaunchLink');
        }
        // parse inputs
    ...
    {
        list($response) = $this->deleteRegistrationGlobalDataWithHttpInfo($registration_id);
        return $response;
    }
    ...
    public function deleteRegistrationGlobalDataWithHttpInfo($registration_id)
    {
        // verify the required parameter 'registration_id' is set
        if ($registration_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $registration_id when calling deleteRegistrationGlobalData');
        }
        // parse inputs
    ...
    {
        list($response) = $this->getRegistrationWithHttpInfo($registration_id);
        return $response;
    }
    ...
    public function getRegistrationWithHttpInfo($registration_id)
    {
        // verify the required parameter 'registration_id' is set
        if ($registration_id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $registration_id when calling getRegistration');
        }
        // parse inputs
        $resourcePath = "/registrations/{registrationId}";
        $httpBody = '';
    ...
    {
        list($response) = $this->testRegistrationPostbackWithHttpInfo($post_back);
        return $response;
    }
    ...
    public function testRegistrationPostbackWithHttpInfo($post_back)
    {
        ...
        if ($post_back === null) {
            throw new \InvalidArgumentException('Missing the required parameter $post_back when calling testRegistrationPostback');
        }
        // parse inputs
