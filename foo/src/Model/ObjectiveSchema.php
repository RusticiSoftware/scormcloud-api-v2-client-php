...
class ObjectiveSchema implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!in_array($this->container['objective_completion'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'objective_completion', must be one of #{allowed_values}.";
        }

        $allowed_values = array("UNKNOWN", "PASSED", "FAILED");
        if (!in_array($this->container['objective_success'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'objective_success', must be one of #{allowed_values}.";
        }

        $allowed_values = array("UNKNOWN", "PASSED", "FAILED");
        if (!in_array($this->container['previous_objective_success'], $allowed_values)) {
            $invalid_properties[] = "invalid value for 'previous_objective_success', must be one of #{allowed_values}.";
        }
    ...
    {
        $allowed_values = array('UNKNOWN', 'COMPLETED', 'INCOMPLETE');
        if (!in_array($objective_completion, $allowed_values)) {
    ...
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!in_array($objective_success, $allowed_values)) {
    ...
    {
        $allowed_values = array('UNKNOWN', 'PASSED', 'FAILED');
        if (!in_array($previous_objective_success, $allowed_values)) {
