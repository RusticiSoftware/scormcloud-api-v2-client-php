 ...
 * @link        https://github.com/swagger-api/swagger-codegen
 */
class CreateRegistrationSchema implements ArrayAccess
{
    /**
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['learner'] === null) {
            $invalid_properties[] = "'learner' can't be null";
        }
        if ($this->container['registration_id'] === null) {
            $invalid_properties[] = "'registration_id' can't be null";
        }
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\RegistrationSchema $initial_registration_state
     * @return $this
     */
     ...
     * @param \RusticiSoftware\Cloud\V2\Model\SettingsPostSchema $initial_settings
     * @return $this
     */
